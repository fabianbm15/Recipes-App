      ...
      <div className="form">
         ...
         >
            ...
            <div>
               ...
               <h6>* Puede agregar varios Dish Types separándolos por una coma (,).</h6>
            </div>
            <div>
            ...
            <div className="diets">
               <div>
                  <input type="checkbox" name="diets" value="vegetarian" onChange={(e) => handleInputChange(e)} />
                  <label>Vegetarian</label>
               </div>
               <div>
                  <input type="checkbox" name="diets" value="gluten free" onChange={(e) => handleInputChange(e)} />
                  <label>Gluten Free</label>
               </div>
               <div>
                  <input type="checkbox" name="diets" value="dairy free" onChange={(e) => handleInputChange(e)} />
                  <label>Dairy Free</label>
               </div>
               <div>
                  <input type="checkbox" name="diets" value="lacto ovo vegetarian" onChange={(e) => handleInputChange(e)} />
                  <label>Lacto-ovo Vegetarian</label>
               </div>
               <div>
                  <input type="checkbox" name="diets" value="vegan" onChange={(e) => handleInputChange(e)} />
                  <label>Vegan</label>
               </div>
               <div>
                  <input type="checkbox" name="diets" value="paleolithic" onChange={(e) => handleInputChange(e)} />
                  <label>Paleolithic</label>
               </div>
               <div>
                  <input type="checkbox" name="diets" value="primal" onChange={(e) => handleInputChange(e)} />
                  <label>Primal</label>
               </div>
               <div>
                  <input type="checkbox" name="diets" value="whole 30" onChange={(e) => handleInputChange(e)} />
                  <label>Whole 30</label>
               </div>
               <div>
                  <input type="checkbox" name="diets" value="pescatarian" onChange={(e) => handleInputChange(e)} />
                  <label>Pescatarian</label>
               </div>
               <div>
                  <input type="checkbox" name="diets" value="ketogenic" onChange={(e) => handleInputChange(e)} />
                  <label>Ketogenic</label>
               </div>
               <div>
                  <input type="checkbox" name="diets" value="fodmap friendly" onChange={(e) => handleInputChange(e)} />
